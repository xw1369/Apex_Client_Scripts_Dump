...
global const ROUND_WINNING_KILL_REPLAY_STARTUP_WAIT = 2.1
global const ROUND_WINNING_KILL_REPLAY_LENGTH_OF_REPLAY = 5.9
global const ROUND_WINNING_KILL_REPLAY_SCREEN_FADE_TIME = 4.0
global const ROUND_WINNING_KILL_REPLAY_POST_DEATH_TIME = 2.0
...
global const GAME_WINNER_DETERMINED_WAIT_WITH_ROUND_WINNING_KILL_REPLAY_WAIT = ROUND_WINNING_KILL_REPLAY_TOTAL_LENGTH + 2.0
...
global const MAX_ASSIST_TIME_GAP						= 30 
