...
global function IsNewcastleReviveShieldEnt
...
global const string NEWCASTLE_REVIVE_SHIELD_SCRIPTNAME = "newcastle_revive_shield"
...
void function MpWeaponReviveShield_Init()
{
	...
	PrecacheScriptString( NEWCASTLE_REVIVE_SHIELD_SCRIPTNAME )
...
bool function IsNewcastleReviveShieldEnt( entity ent )
{
	return ent.GetScriptName() == NEWCASTLE_REVIVE_SHIELD_SCRIPTNAME
}
