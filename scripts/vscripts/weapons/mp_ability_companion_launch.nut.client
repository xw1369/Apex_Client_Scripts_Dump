...
void function Companion_Launch_Init()
{
	...
	RegisterConCommandTriggeredCallback( "+weaponcycle", AttemptCancelLaunch )
	RegisterConCommandTriggeredCallback( "+melee", AttemptCancelLaunch )


	Remote_RegisterServerFunction( "ClientToServer_AttemptCancelLaunch" )
...
int function CanLaunchToCompanion( entity player, entity companion )
{
	...
	bool shouldCheckBlocked = GetCurrentPlaylistVarBool( "vantage_los_check_blocked", false )
