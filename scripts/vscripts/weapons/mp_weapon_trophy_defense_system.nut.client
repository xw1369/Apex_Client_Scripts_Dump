...
const asset TROPHY_EMERGENCY_POWER_FX_UPGRADE = $"P_wpn_trophy_loop_1_CP_color"
...
const int TROPHY_SHIELD_UPGRADED_REPAIR_ADDITIVE = 1
...
const int TROPHY_SHIELD_REGEN_STOCKPILE_AMOUNT = 1
const float TROPHY_SHIELD_REGEN_STOCKPILE_AMOUNT_INTEVAL = 0.5
...
struct
{
	...
	int trophy_shieldRegenAmountAdditive
...
function MpWeaponTrophy_Init()
{
	...
	PrecacheParticleSystem( TROPHY_ELECTRICITY_FX )
		...
		PrecacheParticleSystem( TROPHY_EMERGENCY_POWER_FX_UPGRADE )
	...
	file.trophy_shieldRegenAmount 			= GetCurrentPlaylistVarInt( "wattson_trophy_shieldRegenAmount", TROPHY_SHIELD_REPAIR_AMOUNT )

		file.trophy_shieldRegenAmountAdditive	= GetCurrentPlaylistVarInt( "wattson_trophy_shieldRegenAmountAdditive", TROPHY_SHIELD_UPGRADED_REPAIR_ADDITIVE )
